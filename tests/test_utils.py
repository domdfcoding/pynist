...
def test_parse_name_chars():
	test_strings = {
		...
		"The quick brown fox jumps over a lazy dog.": [  # yapf: disable
		84, 104, 101, 32, 113, 117, 105, 99, 107, 32, 98, 114,
		111, 119, 110, 32, 102, 111, 120, 32, 106, 117, 109, 112,
		115, 32, 111, 118, 101, 114, 32, 97, 32, 108, 97, 122, 121,
		32, 100, 111, 103, 46, 0],
		"Pack my box with five dozen liquor jugs": [  # yapf: disable
		80, 97, 99, 107, 32, 109, 121, 32, 98, 111, 120, 32, 119, 105,
		116, 104, 32, 102, 105, 118, 101, 32, 100, 111, 122, 101, 110,
		32, 108, 105, 113, 117, 111, 114, 32, 106, 117, 103, 115, 0],
		"Mr. Jock, TV quiz PhD, bags few lynx": [  # yapf: disable
		77, 114, 46, 32, 74, 111, 99, 107, 44, 32, 84, 86, 32, 113,
		117, 105, 122, 32, 80, 104, 68, 44, 32, 98, 97, 103, 115, 32,
		102, 101, 119, 32, 108, 121, 110, 120, 0],
